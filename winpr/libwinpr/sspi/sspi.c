        ...
        PSecPkgInfoW* ppPackageInfo)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "EnumerateSecurityPackagesW: %s (0x%04X)",
        ...
        PSecPkgInfoA* ppPackageInfo)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "EnumerateSecurityPackagesA: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        PSecPkgInfoW* ppPackageInfo)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "QuerySecurityPackageInfoW: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        PSecPkgInfoA* ppPackageInfo)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "QuerySecurityPackageInfoA: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        void* pvGetKeyArgument, PCredHandle phCredential, PTimeStamp ptsExpiry)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "AcquireCredentialsHandleW: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        void* pvGetKeyArgument, PCredHandle phCredential, PTimeStamp ptsExpiry)
{
	...
	status = g_SspiA->AcquireCredentialsHandleA(pszPrincipal, pszPackage, fCredentialUse,
	         pvLogonID, pAuthData, pGetKeyFn, pvGetKeyArgument, phCredential, ptsExpiry);
	WLog_Print(g_Log, WLOG_DEBUG, "AcquireCredentialsHandleA: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        PSecBuffer pPackedContext, HANDLE* pToken)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "ExportSecurityContext: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
...
SECURITY_STATUS SEC_ENTRY sspi_FreeCredentialsHandle(PCredHandle phCredential)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "FreeCredentialsHandle: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
        ...
        PSecBuffer pPackedContext, HANDLE pToken, PCtxtHandle phContext)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "ImportSecurityContextW: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        PSecBuffer pPackedContext, HANDLE pToken, PCtxtHandle phContext)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "ImportSecurityContextA: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        ULONG ulAttribute, void* pBuffer)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "QueryCredentialsAttributesW: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        ULONG ulAttribute, void* pBuffer)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "QueryCredentialsAttributesA: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        PSecBufferDesc pOutput, PULONG pfContextAttr, PTimeStamp ptsTimeStamp)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "AcceptSecurityContext: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
...
SECURITY_STATUS SEC_ENTRY sspi_ApplyControlToken(PCtxtHandle phContext, PSecBufferDesc pInput)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "ApplyControlToken: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
...
SECURITY_STATUS SEC_ENTRY sspi_CompleteAuthToken(PCtxtHandle phContext, PSecBufferDesc pToken)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "CompleteAuthToken: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
...
SECURITY_STATUS SEC_ENTRY sspi_DeleteSecurityContext(PCtxtHandle phContext)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "DeleteSecurityContext: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
...
SECURITY_STATUS SEC_ENTRY sspi_FreeContextBuffer(void* pvContextBuffer)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "FreeContextBuffer: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
...
SECURITY_STATUS SEC_ENTRY sspi_ImpersonateSecurityContext(PCtxtHandle phContext)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "ImpersonateSecurityContext: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        PSecBufferDesc pOutput, PULONG pfContextAttr, PTimeStamp ptsExpiry)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "InitializeSecurityContextW: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        PSecBufferDesc pOutput, PULONG pfContextAttr, PTimeStamp ptsExpiry)
{
	...
	status = g_SspiA->InitializeSecurityContextA(phCredential, phContext,
	         pszTargetName, fContextReq, Reserved1, TargetDataRep, pInput,
	         Reserved2, phNewContext, pOutput, pfContextAttr, ptsExpiry);
	WLog_Print(g_Log, WLOG_DEBUG, "InitializeSecurityContextA: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        void* pBuffer)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "QueryContextAttributesW: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        void* pBuffer)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "QueryContextAttributesA: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
...
SECURITY_STATUS SEC_ENTRY sspi_QuerySecurityContextToken(PCtxtHandle phContext, HANDLE* phToken)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "QuerySecurityContextToken: %s (0x%04X)",
	           GetSecurityStatusString(status), status);
	return status;
}
        ...
        void* pBuffer, ULONG cbBuffer)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "SetContextAttributesW: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
        ...
        void* pBuffer, ULONG cbBuffer)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "SetContextAttributesA: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
...
SECURITY_STATUS SEC_ENTRY sspi_RevertSecurityContext(PCtxtHandle phContext)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "RevertSecurityContext: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
        ...
        ULONG MessageSeqNo, PULONG pfQOP)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "DecryptMessage: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
        ...
        PSecBufferDesc pMessage, ULONG MessageSeqNo)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "EncryptMessage: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
        ...
        PSecBufferDesc pMessage, ULONG MessageSeqNo)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "MakeSignature: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
        ...
        ULONG MessageSeqNo, PULONG pfQOP)
{
	...
	WLog_Print(g_Log, WLOG_DEBUG, "VerifySignature: %s (0x%04X)", GetSecurityStatusString(status),
	           status);
	return status;
}
