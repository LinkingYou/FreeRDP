...
typedef struct _WINPR_HMAC_CTX WINPR_HMAC_CTX;

#ifdef __cplusplus
extern "C" {
#endif

WINPR_API WINPR_HMAC_CTX* winpr_HMAC_CTX_new(void);
WINPR_API void winpr_HMAC_CTX_free(WINPR_HMAC_CTX* ctx);
...
WINPR_API int winpr_openssl_BytesToKey(int cipher, int md, const BYTE* salt, const BYTE* data,
